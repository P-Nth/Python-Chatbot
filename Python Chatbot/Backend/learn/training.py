...
from tensorflow.keras.optimizers import SGD  # SARCASTIC GRADING DECENT
...
for wordBlock in dictionary['dictionary']:
    for pattern in wordBlock['patterns']:
        ...
        documents.append((word_list, wordBlock['tag']))
...
prev = model.fit(np.array(train_x), np.array(train_y),
                 epochs=200, batch_size=5, verbose=1)
model.save('ai_model1.h5', prev)
print("Done")
